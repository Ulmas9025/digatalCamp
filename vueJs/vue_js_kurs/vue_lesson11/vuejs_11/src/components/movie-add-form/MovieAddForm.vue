<template>
  <div class="movie-add-form">
      ...
      <form class="add-form d-flex" action="" @submit.prevent>
        <Input class="new-movie-labal" placeholder="Qanday kino?" v-model="name"/>
        <Input type="number" class="new-movie-labal" placeholder="Nechi martaba ko'rilgan?" v-model="viewers"/>      
